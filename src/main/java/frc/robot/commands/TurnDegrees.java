...
public class TurnDegrees extends CommandBase {
   ...
   */
  public TurnDegrees(double speed, double degrees, Drivetrain drive, RomiGyro gyro) {
    m_degrees = degrees;
    m_speed = speed;
    m_drive = drive;
    m_gyro = gyro;
  ...
  @Override
  public void execute() {
    m_drive.arcadeDrive(0, m_speed - TurnConstants.speedDecrement * m_gyro.getAngleZ());
